...
(let
    ...
    (secondary-4   (if (eq theme 'dark) (if (has-true-color) "#212121" "#268bd2") (if (has-true-color) "#F5F5F5" "#268bd2")))
    (secondary-3   (if (eq theme 'dark) (if (has-true-color) "#424242" "#268bd2") (if (has-true-color) "#EEEEEE" "#268bd2")))
    (secondary-2   (if (eq theme 'dark) (if (has-true-color) "#616161" "#268bd2") (if (has-true-color) "#E0E0E0" "#268bd2")))
    (secondary-1   (if (eq theme 'dark) (if (has-true-color) "#757575" "#268bd2") (if (has-true-color) "#BDBDBD" "#268bd2")))
    (secondary     (if (eq theme 'dark) (if (has-true-color) "#9E9E9E" "#268bd2") (if (has-true-color) "#9E9E9E" "#268bd2")))
    (secondary+1   (if (eq theme 'dark) (if (has-true-color) "#BDBDBD" "#268bd2") (if (has-true-color) "#757575" "#268bd2")))
    (secondary+2   (if (eq theme 'dark) (if (has-true-color) "#E0E0E0" "#268bd2") (if (has-true-color) "#616161" "#268bd2")))
    (secondary+3   (if (eq theme 'dark) (if (has-true-color) "#EEEEEE" "#268bd2") (if (has-true-color) "#424242" "#268bd2")))
    (secondary+4   (if (eq theme 'dark) (if (has-true-color) "#F5F5F5" "#268bd2") (if (has-true-color) "#212121" "#268bd2")))
    ...
    (bg1           (if (eq theme 'dark) (if (has-true-color) "#292a2e" "#262626") (if (has-true-color) "#f6f6f6" "#ffffff")))
    ...
    (lnum          (if (eq theme 'dark) (if (has-true-color) "#44505c" "#444444") (if (has-true-color) "#a8a8bf" "#af87af")))
    ...
    (type          (if (eq theme 'dark) (if (has-true-color) "#ce537a" "#df005f") (if (has-true-color) "#ba2f59" "#af005f")))
